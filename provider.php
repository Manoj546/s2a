...
<html lang="en">
    <head>
        ...
        <title>Schloarrship providers form:</title>
      </head>
      
      <body>
        <div class="container">
            <header>Schloarship providers</header>
            <form action="#">
                    ...
                    <div class=" details schloarship">
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <input type="text" placeholder="Enter Provider_id" name="provider" value="<?php echo $provider; ?>" required >
                            </div>
                            <div class="input-field">
