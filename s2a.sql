...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2022 at 05:57 AM
...
--
-- Table structure for table `session history`
--
...
--
-- Indexes for table `session history`
--
ALTER TABLE `session history`
...
--
-- AUTO_INCREMENT for table `session history`
--
ALTER TABLE `session history`
  MODIFY `Session id` int(11) NOT NULL AUTO_INCREMENT;
